  ...
  <div class="app-shell">
    <aside class="app-sidebar">
      ...
      <nav class="side-nav" aria-label="知识底座导航">
        ...
        <RouterLink to="/resources/project-funds" class="nav-item" :class="{ active: section === 'projectFund' }"><el-icon><Folder /></el-icon><span>项目基金</span></RouterLink>
        ...
        <RouterLink to="/kg/topics" class="nav-item" :class="{ active: section === 'topic-graph' }"><el-icon><Connection /></el-icon><span>Topic 中心图谱</span></RouterLink>
...
import { Connection, Document, Folder, Search, Setting, Share, Stamp, User } from '@element-plus/icons-vue'
