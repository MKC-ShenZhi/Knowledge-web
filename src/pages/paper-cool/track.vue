<template>
  <div class="track-page page-shell">
    <div class="page-header">
      <button @click="$router.back()" class="back-btn">返回会议</button>
      <div>
        <p class="page-eyebrow">Conference Hierarchy</p>
        <h2>{{ venueName }} 年份与 Track</h2>
...
.track-page{max-width:1500px;padding:0 0 44px}.page-header{margin-bottom:22px}.page-header .page-eyebrow{margin-bottom:5px}.page-header h2{color:var(--sz-navy);font-size:32px;letter-spacing:-.03em}.back-btn{color:var(--sz-primary);border-color:#cbd6ed;border-radius:9px}.toolbar{padding:18px;border-color:var(--sz-line);border-radius:var(--sz-radius);box-shadow:var(--sz-shadow)}.toolbar-field input{border-color:var(--sz-line);border-radius:8px}.toolbar button{background:var(--sz-primary);border-radius:8px}.track-container{gap:28px}.year-group{padding:24px;background:#fff;border:1px solid var(--sz-line);border-radius:var(--sz-radius);box-shadow:var(--sz-shadow)}.year-title{color:var(--sz-primary)}.theme-grid{grid-template-columns:repeat(auto-fill,minmax(250px,1fr))}.theme-block{min-height:104px;color:var(--sz-text);border-color:var(--sz-line);border-radius:10px}.theme-block small{color:var(--sz-text-muted)}.theme-block:hover{color:var(--sz-primary);border-color:#aebee2;background:var(--sz-primary-faint)}
</style>
