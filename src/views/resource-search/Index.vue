...
const configs={paper:{english:'PAPER SEARCH',title:'论文检索',description:'检索论文题名、摘要、作者、关键词和会议，选择结果进入关系图谱。'},patent:{english:'PATENT SEARCH',title:'专利检索',description:'围绕技术主题、发明名称和应用方向发现相关专利成果。'},scholar:{english:'SCHOLAR SEARCH',title:'学者检索',description:'按照研究主题、姓名和研究方向发现相关学者与合作线索。'},project:{english:'PROJECT SEARCH',title:'项目检索',description:'检索科研项目、关键技术方向和跨机构合作任务。'},fund:{english:'FUND SEARCH',title:'基金检索',description:'检索基金项目、资助方向和相关研究主题。'}} as const
